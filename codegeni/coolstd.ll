...
define noalias i8* @String_substr(i8* nocapture %self, i32 %i, i32 %l) nounwind uwtable {
  %1 = tail call i64 @strlen(i8* %self) nounwind readonly
  %2 = add nsw i32 %l, %i
  %3 = sext i32 %2 to i64
  %4 = icmp ult i64 %1, %3
...
; <label>:5                                       ; preds = %0
  tail call void @error(i8* getelementptr inbounds ([19 x i8]* @.str1, i64 0, i64 0))
  unreachable
...
; <label>:6                                       ; preds = %0
  ...
  %9 = sext i32 %i to i64
  %10 = getelementptr inbounds i8* %self, i64 %9
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %8, i8* %10, i64 %7, i32 1, i1 false)
  ret i8* %8
}
